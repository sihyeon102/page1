...
b.metric("탄수화물", today_row['탄수화물(g)'].item()) #.item이 있어야 데이터 값만 나온다 없으면 표 형식도 같이 있어서 실행X


#4. 차트로 데이터 시각화하기

#4-1. 지도 만들기
map_data = pd.DateFrame({
    'lat' : [37.485475, 37.497539, 37.498014],
    'lon' : [126.501083, 126.486135, 126.549858],
    'school' : ['인천영종고','인천공항고','안천중산고'],
    'students' : [923,662,1190]
})
